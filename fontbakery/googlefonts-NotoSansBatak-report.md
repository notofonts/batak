...
<details><summary><b>[14] NotoSansBatak-Regular.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Check Google Fonts glyph coverage. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyph_coverage">com.google.fonts/check/glyph_coverage</a>)</summary><div>
...
* 🔥 **FAIL** OS/2.fsSelection bit 7 (USE_TYPO_METRICS) wasNOT set in the following fonts: ['fonts/NotoSansBatak/googlefonts/ttf/NotoSansBatak-Regular.ttf']. [code: missing-os2-fsselection-bit7]
...
* ⚠ **WARN** GPOS table lacks kerning info for the following non-ligated sequences:
	...
	- ha-batak + uSign-batak

	- haMandai-batak + uSign-batak

	- ba-batak + uSign-batak

	- karoBa-batak + uSign-batak

	- na-batak + uSign-batak

	- naMandai-batak + uSign-batak

	- wa-batak + uSign-batak

	- ga-batak + uSign-batak

	- ja-batak + uSign-batak 
